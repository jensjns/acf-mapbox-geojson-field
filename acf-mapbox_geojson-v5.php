...
class acf_field_mapbox_geojson extends acf_field {
    ...
    */
    ...
    function input_admin_enqueue_scripts() {
        ...
        wp_register_script( 'acf-input-mapbox_geojson', "{$dir}js/input.js", array('acf-input-mapbox_geojson_mapbox_js', 'acf-input-mapbox_geojson_leaflet_draw_js'), '1.0.0', true );
        wp_enqueue_script( 'acf-input-mapbox_geojson' );
